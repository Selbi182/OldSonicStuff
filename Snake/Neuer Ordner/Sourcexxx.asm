...
WaitFrame:
		...
		move.l	#$00000EEE,d5		; dump colours "black" and "white"

		addq.b	#1,($FFFFF600).w	; increase counter
		btst	#0,($FFFFF600).w	; is counter an odd value?
		bne.s	Even			; if not, branch

		move.l	#$0EEE0000,d5		; dump colours "white" and "black"

Even:
		move.l	d5,(a5)			; write colours to CRAM
